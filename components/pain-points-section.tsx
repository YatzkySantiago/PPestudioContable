...
const painPoints = [
  ...
  {
    icon: Clock,
    text: "Se recuerda la carpeta crediticia recién cuando se necesita hacer frente a un contrato, renovar alguna maquinaria o la compra de alguna unidad nueva.",
    image: "/pain2.webp",
